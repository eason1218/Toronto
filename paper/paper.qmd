...
With respect to the structure of this paper, @sec-data includes an overview of the data and show the results of model; @sec-discussion includes a discussion of the results; and @sec-appendix includes supplementary information.
